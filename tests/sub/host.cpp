...
int main(int argc, const char *argv[])
{
	...
	xt::xarray<double> arg0 = xt::load_npy<double>("sub_arg0.npy");
	xt::xarray<double> arg1 = xt::load_npy<double>("sub_arg1.npy");
	xt::xarray<double> res = xt::load_npy<double>("./sub_result.npy");
