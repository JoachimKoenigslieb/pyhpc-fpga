extern "C" void where3d(double* A, double* B, double* C, int* A_stride, int* B_stride, int* C_stride, int* A_offset, int* B_offset, int* C_offset, int A_lin_offset, int B_lin_offset, int C_lin_offset, double* out, int* out_shape, int* out_stride, int* out_offset, int* out_end_offset, int out_lin_offset) {
