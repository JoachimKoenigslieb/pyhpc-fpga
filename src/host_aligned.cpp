...
void adv_superbee(
							xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> &vel, 
							xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> &var, 
							xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> &mask, 
							xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> &dx, 
							int axis, 
							xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> &cost, 
							xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> &cosu, 
							xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> &out, 
							std::vector<int> out_shape, 
							std::vector<int> out_starts, 
							std::vector<int> out_ends,
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> zero = xt::zeros<double>({1});	
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> one = xt::ones<double>({1});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> two = xt::ones<double>({1}) * 2;

	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> velfac, dx_local;
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> vel_pad_temp;
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> var_pad_temp;
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> mask_pad_temp;
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> uCFL = xt::zeros<double>(intermediate_shape);
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> rjp = xt::zeros<double>(intermediate_shape);
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> rj = xt::zeros<double>(intermediate_shape);
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> rjm = xt::zeros<double>(intermediate_shape);
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> cr = xt::zeros<double>(intermediate_shape);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> selection = xt::zeros_like(vel);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> eps = xt::ones<double>({1}) * 1e-20;
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> abs_rj = xt::zeros_like(rj);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> cr_temp = xt::zeros_like(cr);
	...
	//compute out value.
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> temp_out = xt::zeros_like(out);
...
int main(int argc, const char *argv[])
{
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> u = xt::load_npy<double>("../src/numpy_files/u.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> v = xt::load_npy<double>("../src/numpy_files/v.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> w = xt::load_npy<double>("../src/numpy_files/w.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> maskU = xt::load_npy<double>("../src/numpy_files/maskU.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> maskV = xt::load_npy<double>("../src/numpy_files/maskV.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> maskW = xt::load_npy<double>("../src/numpy_files/maskW.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> dxt = xt::load_npy<double>("../src/numpy_files/dxt.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> dxu = xt::load_npy<double>("../src/numpy_files/dxu.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> dyt = xt::load_npy<double>("../src/numpy_files/dyt.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> dyu = xt::load_npy<double>("../src/numpy_files/dyu.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> dzt = xt::load_npy<double>("../src/numpy_files/dzt.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> dzw = xt::load_npy<double>("../src/numpy_files/dzw.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> cost = xt::load_npy<double>("../src/numpy_files/cost.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> cosu = xt::load_npy<double>("../src/numpy_files/cosu.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> kbot = xt::load_npy<double>("../src/numpy_files/kbot.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> forc_tke_surface = xt::load_npy<double>("../src/numpy_files/forc_tke_surface.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> kappaM = xt::load_npy<double>("../src/numpy_files/kappaM.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> mxl = xt::load_npy<double>("../src/numpy_files/mxl.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> forc = xt::load_npy<double>("../src/numpy_files/forc.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> tke = xt::load_npy<double>("../src/numpy_files/tke.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> dtke = xt::load_npy<double>("../src/numpy_files/dtke.npy");
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> flux_east = xt::zeros<double>({X, Y, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> flux_north = xt::zeros<double>({X, Y, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> flux_top = xt::zeros<double>({X, Y, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> sqrttke = xt::empty<double>({X, Y, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> a_tri = xt::zeros<double>({X-4, Y-4, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> b_tri = xt::zeros<double>({X-4, Y-4, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> b_tri_edge = xt::zeros<double>({X-4, Y-4, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> c_tri = xt::zeros<double>({X-4, Y-4, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> d_tri = xt::zeros<double>({X-4, Y-4, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> delta = xt::zeros<double>({X-4, Y-4, Z});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> ks = xt::zeros<double>({X-4, Y-4});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> tke_surf_corr = xt::zeros<double>({X,Y});
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> one = xt::ones<double>({1});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> zero = xt::zeros<double>({1});
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> half = xt::ones<double>({1}) * 0.5;
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> three_halfs = xt::ones<double>({1}) * 1.5;
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> two = xt::ones<double>({1}) * 2;
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> K_h_tke = xt::ones<double>({1}) * 2000;
	...
	//b_tri
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> b_tri_tmp = xt::zeros<double>({X-4, Y-4, Z});
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> c_eps_hack = xt::ones<double>({1}) * c_eps;
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> b_tri_edge_tmp = xt::zeros_like(b_tri_edge);
	inputs = {sqrttke.data(), mxl.data() };
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> d_tri_tmp = xt::zeros_like(d_tri);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> land_mask = xt::zeros_like(ks);
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> edge_mask = xt::zeros_like(a_tri);
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> water_mask = xt::zeros_like(a_tri);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> Z_dim_arange = xt::arange(Z);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> not_edge_mask = xt::zeros_like(edge_mask);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> mask = xt::zeros<double>({X-4,Y-4});
	...
	// Tke temp stuff
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> tke_temp = xt::zeros<double>({X, Y, Z});
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> maskUtr = xt::zeros_like(maskW);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> maskVtr = xt::zeros_like(maskW);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> maskWtr = xt::zeros_like(maskW);
	...
	//dtke
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> dtke_temp = xt::zeros_like(dtke);
	...
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> three_halves_plus_AB_eps = xt::ones<double>({1}) * (1.5 + 0.1);
	xt::xarray<double, XTENSOR_DEFAULT_LAYOUT, xsimd::aligned_allocator<double, 4096>> one_halves_plus_AB_eps = xt::ones<double>({1}) * (0.5 + 0.1);
	...
	std::cout << "tke surf corr: " << xt::sum(tke_surf_corr) << std::endl;
	std::cout << "flux east: " << xt::sum(flux_east) << std::endl;
	std::cout << "flux north: " << xt::sum(flux_north) << std::endl;
	std::cout << "flux top: " << xt::sum(flux_top) << std::endl;
	std::cout << "dtke: " << xt::sum(dtke) << std::endl;
	return 0;
}
